...
window.onload = function() {
    ...
    function init() {
        // Load images
        images = loadImages(["/main/imgs/snake-graphics.png"]);
        tileimage = images[0];
    ...
    // Add an money to the level at an empty position
    function addMoney() {
        // Loop until we have a valid money
        var valid = false;
        while (!valid) {
            ...
            // Make sure the snake doesn't overlap the new money
            var overlap = false;
            ...
            if (!overlap && level.tiles[ax][ay] == 0) {
                // Add an money at the tile position
                level.tiles[ax][ay] = 2;
                valid = true;
            }
        }
